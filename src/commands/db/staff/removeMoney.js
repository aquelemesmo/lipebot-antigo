...
module.exports.run = async (bot,message,args) => {
    ...
    .setDescription("Foi removido " + quantia + " do usuário " + membro.user.username)
    message.quote(embed)
    db.subtract(`moedinhas_${message.guild.id}_${membro.id}`)
}

module.exports.help = {
    name: "removeMoney",
    aliases: ["removerMoney", "deleteMoney"]
}